...
8. **The native binary exists for `windows-x64` only, and since ADR-029 that no longer blocks
   ...
   binding constraint. No CI step compiles the `.rs` sources; the 248,320-byte `.exe` is committed
