...
These are the releases that change what ADR Kit does; full detail, including the
patch releases, is in [CHANGELOG.md](CHANGELOG.md).
...
For another project, use the published package for v0.52.2:
...
jobs:
  adr-judge:
    ...
    steps:
      ...
      - uses: rvdbreemen/adr-kit/.github/actions/adr-judge@v0.52.2
        with:
          adr-dir: docs/adr/
```
