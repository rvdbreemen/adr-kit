---
name: judge
description: Check the staged diff against Accepted ADR enforcement rules, then review semantic rules in the active Copilot CLI session.
license: MIT
---
...
For ADRs marked `llm_judge: true`, assess the diff in the active Copilot CLI session
